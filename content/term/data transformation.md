...
Data is often transformed as part of an [ETL (Extract, Transform, Load)](term/etl.md) or [ELT (Extract, Load, Transform)](term/elt.md) [data integration](https://airbyte.com/blog/data-integration) approach. 
